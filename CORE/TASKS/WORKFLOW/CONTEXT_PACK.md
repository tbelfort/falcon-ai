...
|---------------------|----------------|---------------------|
| `src/packages/foundry/*` | foundry-package | `[TYPE: foundry-package]` |
| `src/packages/forge/*` | forge-stage | `[TYPE: forge-stage]` |
| `src/apps/*/weavers/` | weaver | `[TYPE: weaver]` |
| `src/apps/*/workers/` | worker | `[TYPE: worker]` |
| `src/apps/*/engine/` | engine | `[TYPE: engine]` |
| `src/apps/*/ux/` | ux | `[TYPE: ux]` |
...
Use the template at `CORE/TEMPLATES/gemini/research-gotchas.md`.
...
Key areas by type:
- **foundry-package / forge-stage:** Pydantic patterns, import boundaries
- **forge-stage:** Artifact patterns, receipts, manifests
- **worker / engine / weaver:** Async patterns, timeouts, cancellation

### IF [TYPE: ux]

Research React/TypeScript patterns:
- Existing component patterns in `src/apps/*/ux/`
