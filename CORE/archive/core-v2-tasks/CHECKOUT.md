...
| Ready for Spec | Read `.claude/CORE/TASKS/SPEC.md` |
...
1. **If `needs_improve_context_pack` label exists:** Read `.claude/CORE/TASKS/CONTEXT_PACK_IMPROVE.md`
2. **Otherwise (no label):** Read `.claude/CORE/TASKS/CONTEXT_PACK_REVIEW.md`
