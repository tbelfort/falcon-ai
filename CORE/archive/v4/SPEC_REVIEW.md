...
- `docs/architecture/COMPONENT-TYPES.md` — Component type requirements
- `docs/architecture/LAYERS.md` — Import boundary rules
- `docs/architecture/SECURITY.md` — Path security and validation strictness
- `docs/architecture/QUALITY-ATTRIBUTES.md` — Test count formula and error handling
...
2. Check forbidden imports per `docs/architecture/LAYERS.md` and `docs/architecture/COMPONENT-TYPES.md`
...
Verify spec follows error handling patterns from `docs/architecture/QUALITY-ATTRIBUTES.md#error-handling-requirements`:
...
For each frozen model, verify collection fields use immutable types per `docs/architecture/COMPONENT-TYPES.md#pydantic-model-requirements`:
- `tuple[X, ...]` not `list[X]`
...
Verify cross-field validators exist for related fields per `docs/architecture/COMPONENT-TYPES.md#pydantic-model-requirements`:
...
Verify spec follows strict validation by default per `docs/architecture/SECURITY.md#validation-strictness`.
...
Calculate minimum tests using formula from `docs/architecture/QUALITY-ATTRIBUTES.md#minimum-test-count-formula`.
...
Based on component type from spec Section 0, apply the relevant checks below. See `docs/architecture/COMPONENT-TYPES.md` for the full requirements matrix.

---

### A3.1: Protocol Design Verification (IF foundry-package)

Per `docs/architecture/COMPONENT-TYPES.md`, verify:
...
Per `docs/architecture/ARTIFACTS.md` and `docs/architecture/COMPONENT-TYPES.md`, verify:
...
Per `docs/architecture/COMPONENT-TYPES.md#async-behavior-requirements`, verify:
...
Per `docs/architecture/SECURITY.md#path-security-artifact-paths`, verify ALL 9 path validations are present in the spec with corresponding test cases.
