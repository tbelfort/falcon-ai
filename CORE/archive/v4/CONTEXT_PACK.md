...
1. **Read the architecture docs** to understand which rules apply:
   - `docs/architecture/ARCHITECTURE-simple.md` — Non-negotiables checklist
   - `docs/architecture/COMPONENT-TYPES.md` — Component-specific requirements matrix
   - `docs/architecture/LAYERS.md` — Import boundary rules
   - `docs/architecture/SECURITY.md` — Path validation rules (9 required)
   - `docs/architecture/QUALITY-ATTRIBUTES.md` — Test formula, error handling
...
Based on component type, research additional areas per `docs/architecture/COMPONENT-TYPES.md`.
