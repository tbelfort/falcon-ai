...
- `docs/architecture/QUALITY-ATTRIBUTES.md` — Test count formula and required categories
- `docs/architecture/COMPONENT-TYPES.md` — Component-specific test requirements
- `docs/architecture/SECURITY.md` — Path security test cases
...
Per `docs/architecture/COMPONENT-TYPES.md`:

- **Pydantic models:** Construction, validation, immutability, cross-field validation
- **Path handling:** 9 security tests per `docs/architecture/SECURITY.md#path-security-artifact-paths`
...
Calculate minimum tests using the formula from `docs/architecture/QUALITY-ATTRIBUTES.md#minimum-test-count-formula`.
