...
python project-management/tools/linear.py issue update CON-XXX --state "Context Pack in Progress"
...
# Comment to claim
python project-management/tools/linear.py issue comment CON-XXX "Agent [Model Name] $AGENT_NAME: Starting Context Pack work."
```
...
python project-management/tools/linear.py document create "CON-XXX Context Pack: <short title>" \
...
```bash
# Move to Context Pack Drafted status
python project-management/tools/linear.py issue update CON-XXX --state "Context Pack Drafted"

# Add has_context_pack label
python project-management/tools/linear.py issue update CON-XXX --add-label has_context_pack
...
python project-management/tools/linear.py issue comment CON-XXX "Agent [Model Name] $AGENT_NAME: Context Pack complete.
...
python project-management/tools/linear.py issue comment CON-XXX "Agent [Model Name] $AGENT_NAME: Context Pack blocked.
