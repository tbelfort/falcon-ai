...
import type { ProjectDto, LabelDto, AsyncState } from '../api/types';
...
export const useProjectStore = create<ProjectState>((set, get) => ({
  ...
  fetchProjects: async () => {
    ...
    try {
      ...
      const message = e instanceof ApiClientError ? e.message : 'Failed to fetch projects';
  ...
  fetchLabels: async (projectId: string) => {
    ...
    try {
      ...
      const message = e instanceof ApiClientError ? e.message : 'Failed to fetch labels';
