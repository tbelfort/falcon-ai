...
1. **SQL Injection Prevention** → `technical.md` (AD4), `systems/architecture/ARCHITECTURE-simple.md` (S1)
2. **Path Validation** → `systems/architecture/ARCHITECTURE-simple.md` (S2)
3. **Error Message Sanitization** → `systems/architecture/ARCHITECTURE-simple.md` (S3), `systems/errors.md`
4. **Financial Data Protection** → `systems/architecture/ARCHITECTURE-simple.md` (S4)
